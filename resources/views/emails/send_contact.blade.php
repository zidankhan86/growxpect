                            ...
                            <tr>
                                <td class="header"
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" href="{{ $data['site_url'] }}"
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 19px; font-weight: bold; text-decoration: none;">
                                        {{ $data['site_name'] }}
                                    </a>
                                </td>
                            </tr>
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            If you have any inquiries, please feel free
